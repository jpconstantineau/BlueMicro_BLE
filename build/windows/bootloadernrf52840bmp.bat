...
@echo %bmpprefix%
%bmpprefix% --batch -ex "target extended-remote \\.\%1" -ex "mon swdp_scan" -ex "att 2" -ex "mon erase_mass"
...
%bmpprefix% %bootloaderfullname% --batch -ex "target extended-remote \\.\%1" -ex "mon swdp_scan" -ex "att 1" -ex "load " -ex "kill" -ex "quit"
