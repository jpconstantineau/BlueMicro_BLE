...
|---|---|---|
| Master  |  ![Build Status](http://http://[2001:470:1d:a66::1b5a]:8080/buildStatus/icon?job=BlueMicro_BLE%20-%20Push)  |![Adafruit Library for releases](https://img.shields.io/github/release/adafruit/Adafruit_nRF52_Arduino.svg)  |
| Develop |![Build Status](http://http://[2001:470:1d:a66::1b5a]:8080/buildStatus/icon?job=BlueMicro_BLE-develop)   | ![Adafruit Library for releases](https://img.shields.io/github/release/adafruit/Adafruit_nRF52_Arduino.svg)   |
