...
void setupKeymap() {
    ...
    uint32_t layer1[MATRIX_ROWS][MATRIX_COLS] =
        ...
        LAYER_2,KC_VOLD,KC_VOLU,KC_MUTE,KC_NO,KC_NO,KC_PAST,KC_PSLS,KC_HOME,KC_PGUP,KC_LEFT,KC_RGHT,KC_PENT, \
    ...
    uint32_t layer2[MATRIX_ROWS][MATRIX_COLS] =
        ...
        KC_CAPS,BLEPROFILE_1,BLEPROFILE_2,BLEPROFILE_3,KC_NO,KC_NO,KC_NO,KC_MS_BTN1,KC_MS_BTN2,KC_MS_BTN3,KC_MS_BTN4,KC_MS_BTN5,KC_NO,SLEEP_NOW, \
        KC_NO,KC_NO,WIN_E_GRAVE,WIN_E_ACUTE,WIN_E_CIRCU,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,PRINT_BATTERY,PRINT_INFO,PRINT_BLE, \
        LAYER_2,UF2_DFU,KC_NO,KC_NO,KC_NO,KC_MS_UP,KC_NO,KC_NO,KC_NO,KC_NO,KC_MS_WH_UP,BATTERY_CALC_TEST,BATTERY_CALC_DEFAULT, \
        GITCOMMIT,KC_NO,KC_NO,KC_NO,KC_MS_LEFT,KC_MS_DOWN,KC_MS_RIGHT,KC_NO,KC_MS_WH_LEFT,KC_MS_WH_DOWN,KC_MS_WH_RIGHT,KC_UP, \
        RESET,KC_NO,KC_NO,          CHARGE,                    LAYER_1,KC_LEFT,KC_DOWN,KC_RIGHT);
